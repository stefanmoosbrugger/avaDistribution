// OpenLayersVectorTileLayerWithMarkers.tsx
...
const OpenLayersVectorTileLayerWithMarkers: React.FC<Props> = ({ filter, regionSummaries, maxCounts }) => {
   const map = useMap();
      ...
      const vectorTileLayer = new VectorTileLayer({
         ...
         style: (feature) => {
            ...
            const consideredRegion =
               id?.startsWith("AT") || id?.startsWith("CH") || id?.startsWith("DE") ||
               id?.startsWith("IT-2") || id?.startsWith("IT-3") || id?.startsWith("IT-5");
            ...
            if (props.layer !== "micro-regions" || !isCurrentFeature(props) || !consideredRegion) {
               return new Style({});
            }
